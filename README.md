...
|-------|------------------|----------|----------|
| **Theme** | `data-theme` | Color palette | `pinion`, `pinion-dark`, `monokai`, `payments-dark` (45 original light/dark pairs — see `AGENTS.md` for the catalog) |
